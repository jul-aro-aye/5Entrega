...
if ($_GET["akzioa"] == "lortugidariak") {
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $gidariak[$counter] = ["postua" => $row["Postua"], "dortsala" => $row["Dortsala"], "izena" => $row["Izena"]]; // gidariaren datuak array batean gordetzen ditu
        ...
        $gidariak["kopurua"] = 0; // gidariaren arrayan kopurua 0 izango da
        // gidariak arraya JSON formatuan bidaltzen du
        echo json_encode($gidariak);
        // Prozesua amaitzen du
        die;
